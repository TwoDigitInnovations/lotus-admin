        ...
        <div key={s} className="flex items-center gap-2">
          ...
          {s < 3 && (
            <div
              ...
              style={{
                background: step > s ? "#078DD4" : "#e5e7eb",
              }}
            />
          )}
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 w-full">
          ...
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs">
              Follow the steps to verify your identity and reset your password
              securely.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col bg-white">
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-sm">
            ...
            <button
              onClick={() =>
                step === 1 ? router.push("/login") : setStep((s) => s - 1)
              }
            ...
            <p className="text-sm text-gray-400 mb-6">{stepDesc[step - 1]}</p>
                  ...
                  {[
                    ...
                    <div key={rule.label} className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          background: rule.test ? "#078DD4" : "#d1d5db",
                        }}
                      />
                      <span
                        className="text-xs transition-colors"
                        style={{ color: rule.test ? "#078DD4" : "#9ca3af" }}
                      >
                        {rule.label}
                      </span>
                    </div>
