        ...
        <div className="relative z-10 flex flex-col justify-between p-10 w-full">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold text-white leading-snug mb-3">
              Manage Your<br />Luxury Properties
            </h2>
            ...
            <div className="mb-2">
              ...
              <div className={inputCls(submitted && !userDetail.password)}>
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="bg-transparent outline-none w-full text-sm text-slate-800 placeholder-slate-400 pr-2"
                  value={userDetail.password}
                  onChange={(e) => setUserDetail({ ...userDetail, password: e.target.value.trim() })}
                  onKeyDown={(e) => e.key === "Enter" && submit()}
                />
                <button
                  type="button"
